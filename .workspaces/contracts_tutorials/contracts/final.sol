...
contract Code_for_erc
{
   ...
   // using SafeMath for uint256;
    ...
    function totalSupplyFun(uint256 total) public  payable
    {
        totalSupply_ = total;
    ...
    function getBalanceContract()public view returns(uint) //seeing getBalanceContractB
    {
